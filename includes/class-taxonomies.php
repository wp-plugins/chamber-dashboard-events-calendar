...
new Cdash_Events_Taxonomies($cdash_events);

class Cdash_Events_Taxonomies
{
	private $options;
	...
	*/
	...
	{
		$this->category_fields = apply_filters('cde_event_category_fields', array(
			'color' => array(
				'label' => __('Color', 'cdash-events'),
				'default' => '',
		...
		$this->location_fields = apply_filters('cde_event_location_fields', array(
			'google-map' => array(
				'label' => __('Map', 'cdash-events'),
				'default' => '',
				'description' => '',
				'column' => false
			),
			'address' => array(
				'label' => __('Address', 'cdash-events'),
				'default' => '',
				'description' => '',
				'column' => false
			),
			'city' => array(
				'label' => __('City', 'cdash-events'),
				'default' => '',
				'description' => '',
				'column' => false
			),
			'state' => array(
				'label' => __('State / Province', 'cdash-events'),
				'default' => '',
				'description' => '',
				'column' => false
			),
			'zip' => array(
				'label' => __('Zip Code', 'cdash-events'),
				'default' => '',
				'description' => '',
				'column' => false
			),
			'country' => array(
				'label' => __('Country', 'cdash-events'),
				'default' => '',
				'description' => '',
				'column' => false
			),
			'image' => array(
				'label' => __('Image', 'cdash-events'),
				'default' => '',
				'description' => '',
				'column' => false
			)
				...
				case 'image':
			        $html .= '
						<div id="em-tax-image-buttons">
							<label>'.$field['label'].'</label>
							<input id="cde_upload_image_id" type="hidden" name="term_meta[image]" value="0" />
							<input id="cde_upload_image_button" type="button" class="button button-secondary" value="'.__('Select image', 'cdash-events').'" />
							<input id="cde_turn_off_image_button" type="button" class="button button-secondary" value="'.__('Remove image', 'cdash-events').'" disabled="disabled" />
				...
				case 'image':
			        $html .= '
			        	<th scope="row" valign="top">
							...
							<td>
							<div id="em-tax-image-buttons">
								<input id="cde_upload_image_id" type="hidden" name="term_meta[image]" value="'.(int)$image_id.'" />
								<input id="cde_upload_image_button" type="button" class="button button-secondary" value="'.__('Select image', 'cdash-events').'" />
								<input id="cde_turn_off_image_button" type="button" class="button button-secondary" value="'.__('Remove image', 'cdash-events').'" '.disabled($image_id, 0, false).' />
								<span class="em-spinner"></span>
							</div>
	...
	*/
	public function event_category_manage_columns_content($output, $column_name, $term_id)
	{
		...
		return apply_filters('cde_event_category_column_content', $output, $column_name, $term_id);
	}
}
?>