...
<div class="archive-meta entry-meta">
    ...
    if (!empty($location) && !is_wp_error($location)) : ?>
	    ...
	    <?php if (!empty($location_details['address'])) : ?>	    	
	    	<div class="location-address"><strong><?php echo __('Address', 'cdash-events'); ?>:</strong> <?php echo $location_details['address']; ?></div>
	    <?php endif; ?>
	    
	    <?php if (!empty($location_details['zip'])) : ?>    	
	    	<div class="location-zip"><strong><?php echo __('Zip Code', 'cdash-events'); ?>:</strong> <?php echo $location_details['zip']; ?></div>
	    <?php endif; ?>
	    
	    <?php if (!empty($location_details['city'])) : ?>   	
	    	<div class="location-city"><strong><?php echo __('City', 'cdash-events'); ?>:</strong> <?php echo $location_details['city']; ?></div>
	    <?php endif; ?>
	    
	    <?php if (!empty($location_details['state'])) : ?>	
	    	<div class="location-state"><strong><?php echo __('State / Province', 'cdash-events'); ?>:</strong> <?php echo $location_details['state']; ?></div>
	    <?php endif; ?>
	         
	    <?php if (!empty($location_details['country'])) : ?>	
	    	<div class="location-country"><strong><?php echo __('Country', 'cdash-events'); ?>:</strong> <?php echo $location_details['country']; ?></div>
	    <?php endif; ?>
	    ...
	    <?php if (!empty($location_details['image'])) : ?>
        	...
        	<div class="archive-thumbnail location-image">
        		...
        		<strong><?php echo __('Image', 'cdash-events'); ?>:</strong><br />
