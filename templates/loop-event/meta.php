...
<div class="entry-meta">
	...
	<?php
	/**
	 * cde_loop_event_meta_start hook
	 * 
	 * @hooked cde_display_event_date - 10
	 */
	do_action('cde_loop_event_meta_start');
	?>
	...
	<?php
	/**
	 * cde_loop_event_meta_end hook
	 */
	do_action('cde_loop_event_meta_end');
	?>
